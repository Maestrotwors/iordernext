...
export class AdaptiveService {
  ...
  public isTabletAndLess = new BehaviorSubject(false);
  //window.innerWidth < ADAPTIVE.maxTabletAndLess ? true : false
  public isTabletOrDesktop = new BehaviorSubject(false
    //window.innerWidth > ADAPTIVE.maxMobile ? true : false
  );
  public isSmallMobile = new BehaviorSubject(false);
  //window.innerWidth < ADAPTIVE.maxSmallMobile ? true : false
  public isDesktop = new BehaviorSubject(false);
  //window.innerWidth >= ADAPTIVE.maxTabletAndLess ? true : false
